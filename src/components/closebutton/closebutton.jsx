	...
	render(props) {
		...
		return (
			<span
				...
				onClick={onClick} style={{boxShadow: "0 0 0 3px "+config.themeColor}}>
				<svg width={width} height={height} viewBox='0 0 16 16' preserveAspectRatio='xMidYMid meet' style={{fill: config.themeColor}}>
